...
import { LayoutDashboard, Package, PieChart, Share2, LogOut, Menu, X } from "lucide-react"
...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: "/seller/budget", label: "Budget", icon: PieChart },
    { href: "/seller/posts", label: "Post Generator", icon: Share2 },
  ]
  ...
  return (
    <>
      ...
      >
        <div className="p-6">
          <Link href="/seller/dashboard" className="flex items-center gap-2 mb-8">
            <div className="w-10 h-10 bg-sidebar-primary rounded-lg flex items-center justify-center">
              <span className="text-sidebar-primary-foreground font-bold">S</span>
            </div>
            <span className="font-bold text-lg text-sidebar-foreground">SheCrafts</span>
          </Link>
